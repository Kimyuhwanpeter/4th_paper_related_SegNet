...
def main():
    ...
    model = SegNet_model(input_shape=(FLAGS.img_size, FLAGS.img_size, 3), classes=FLAGS.total_classes)
    m = tf.keras.applications.VGG16()
    m.summary()

    model.get_layer("conv1").set_weights(m.get_layer("block1_conv1").get_weights())
    model.get_layer("conv2").set_weights(m.get_layer("block1_conv2").get_weights())
    model.get_layer("conv3").set_weights(m.get_layer("block2_conv1").get_weights())
    model.get_layer("conv4").set_weights(m.get_layer("block2_conv2").get_weights())
    model.get_layer("conv5").set_weights(m.get_layer("block3_conv1").get_weights())
    model.get_layer("conv6").set_weights(m.get_layer("block3_conv2").get_weights())
    model.get_layer("conv7").set_weights(m.get_layer("block3_conv3").get_weights())
    model.get_layer("conv8").set_weights(m.get_layer("block4_conv1").get_weights())
    model.get_layer("conv9").set_weights(m.get_layer("block4_conv2").get_weights())
    model.get_layer("conv10").set_weights(m.get_layer("block4_conv3").get_weights())
    model.get_layer("conv11").set_weights(m.get_layer("block5_conv1").get_weights())
    model.get_layer("conv12").set_weights(m.get_layer("block5_conv2").get_weights())
    model.get_layer("conv13").set_weights(m.get_layer("block5_conv3").get_weights())
